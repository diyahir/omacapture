...
pub fn handle(gb: &Rc<Grabbit>, frame: Frame, mode: CaptureMode) -> Outcome {
...
pub fn run_actions(gb: &Rc<Grabbit>, frame: Frame, actions: AfterCapture, allow_annotate: bool) -> Outcome {
    let cfg = gb.config.get();
